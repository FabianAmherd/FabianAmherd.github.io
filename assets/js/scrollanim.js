...
function firstinit(){
  ...
  tl1.from(".introductory-text", .6, {y:100, opacity:0})
  ...
  tl2.from(".pricing-preview-element:nth-of-type(3)", .3, {y: 100, opacity:0}, "=-.3")
  tl2.from(".pricing-preview-element:nth-of-type(4)", .3, {y: 100, opacity:0}, "=-.3")
  tl2.from(".preview-btn", .4, {scale: 0})
  ...
  tl4.from(".grid-element:nth-of-type(3)", .5, {x:-100, opacity:0}, "=-.5")
  tl4.from(".grid-element:nth-of-type(4)", .5, {x:100, opacity:0}, "=-.5")
  tl4.from(".grid-element:nth-of-type(5)", .5, {x:-100, opacity:0}, "=-.5")
  tl4.from(".grid-element:nth-of-type(6)", .5, {x:100, opacity:0}, "=-.5")
  ...
  tl5.from(".contact-btn", .4, {scale: 0}, "=-.4")
  tl5.from(".contact-element", .4, {opacity:0}, "=-.2")
...
function whatever() {
  if (!doneTheStuff) {
    ...
    tl9.from(".extra-element:nth-of-type(6)", .4, {scale: 1.1, opacity:0}, "=-.4")
    tl9.from(".extra-element:nth-of-type(2)", .4, {scale: 1.1, opacity:0}, "=-.4")
    tl9.from(".extra-element:nth-of-type(5)", .4, {scale: 1.1, opacity:0}, "=-.4")
    ...
    tl10.from(".tte", .4, {x:-200, opacity:0}, "=-.4")
    tl10.from(".translation-btn", .4, {y:200, opacity:0}, "=-.4")
